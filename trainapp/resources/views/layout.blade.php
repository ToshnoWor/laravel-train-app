...
<header class="p-2">
    <div class="d-flex flex-column flex-md-row align-items-center pb-3 mb-4 border-bottom bg-dark">
        <a href="/" class="d-flex align-items-center link-body-emphasis text-decoration-none text-white">
            ...
            <span class="fs-4 text-white">Train App</span>
        </a>

        <nav class="d-inline-flex mt-2 mt-md-0 ms-md-auto">
            <a class="me-3 py-2 link-body-emphasis text-decoration-none text-white" href="/">Home</a>
            <a class="me-3 py-2 link-body-emphasis text-decoration-none text-white" href="/about">About</a>
        </nav>
        <a class="btn btn-outline-warning" href="/review">Comment</a>
    </div>
</header>
